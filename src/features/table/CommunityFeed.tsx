...
export const Feed: FC<CommunityFeedProps> = ({}) => {
  return (
    <div className="w-4/5 flex justify-between items-center p-2 transition duration-300 ease-in-out hover:bg-gray-200 rounded-[16px] relative">
      <Link href={`/community/post/1`}>
        <div className="self-start flex flex-col items-start min-w-0 pr-md">
          ...
          <div className="text-18 cursor-pointer line-clamp-3 text-ellipsis text-gray-700 font-semibold mb-2 no-underline hover:no-underline visited:text-neutral-content-weak">
            <span className="font-bold visited:text-neutral-content-weak">
              ...
              incidunt officiis perspiciatis alias ab vitae earum cupiditate
              animi sed pariatur. Exercitationem, modi dolorem.
            </span>
          </div>
